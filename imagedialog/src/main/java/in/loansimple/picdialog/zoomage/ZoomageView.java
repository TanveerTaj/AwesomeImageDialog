 ...
 */
package in.loansimple.picdialog.zoomage;
...
import in.loansimple.picdialog.R;
            ...
            if (doubleTapToZoom && doubleTapDetected) {
                ...
                if (matrixValues[Matrix.MSCALE_X] != startValues[Matrix.MSCALE_X]) {
                    ...
                    if (zoomCallback != null) {
                        zoomCallback.onZoom(true);
                    }
//                    ImageActivity.background.setBackgroundColor(getResources().getColor(R.color.black));
    ...
    public void reset() {
        ...
        if (zoomCallback != null) {
            zoomCallback.onZoom(false);
        }
//        ImageActivity.background.setBackgroundColor(getResources().getColor(R.color.transparent));
//        ImageActivity.closeButton.show();
    }
